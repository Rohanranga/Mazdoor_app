...
class FanRegulatorPage extends StatefulWidget {
  const FanRegulatorPage({super.key});

  @override
  _FanRegulatorPageState createState() => _FanRegulatorPageState();
}

class _FanRegulatorPageState extends State<FanRegulatorPage> {
