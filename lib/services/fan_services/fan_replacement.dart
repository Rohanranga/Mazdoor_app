...
class FanReplacementPage extends StatefulWidget {
  const FanReplacementPage({super.key});

  @override
  _FanReplacementPageState createState() => _FanReplacementPageState();
}

class _FanReplacementPageState extends State<FanReplacementPage> {
