...
class LightInstallationPage extends StatefulWidget {
  const LightInstallationPage({super.key});

  @override
  _LightInstallationPageState createState() => _LightInstallationPageState();
}

class _LightInstallationPageState extends State<LightInstallationPage> {
