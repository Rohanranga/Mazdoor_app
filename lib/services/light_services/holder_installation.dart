...
class BulbHolderInstallationPage extends StatefulWidget {
  const BulbHolderInstallationPage({super.key});

  @override
  _BulbHolderInstallationPageState createState() =>
      _BulbHolderInstallationPageState();
}

class _BulbHolderInstallationPageState
    extends State<BulbHolderInstallationPage> {
