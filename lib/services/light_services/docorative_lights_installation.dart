...
class DecorativeLightsInstallationPage extends StatefulWidget {
  const DecorativeLightsInstallationPage({super.key});

  @override
  _DecorativeLightsInstallationPageState createState() =>
      _DecorativeLightsInstallationPageState();
}

class _DecorativeLightsInstallationPageState
    extends State<DecorativeLightsInstallationPage> {
  ...
  void fetchOrCreatePrice() async {
    try {
      DocumentReference docRef = FirebaseFirestore.instance
          .collection('prices')
          .doc('decorative_lights_installation');
