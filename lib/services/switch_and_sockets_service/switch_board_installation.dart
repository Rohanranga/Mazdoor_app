...
class SwitchBoardInstallation extends StatefulWidget {
  const SwitchBoardInstallation({super.key});

  @override
  _SwitchBoardInstallationState createState() =>
      _SwitchBoardInstallationState();
}

class _SwitchBoardInstallationState extends State<SwitchBoardInstallation> {
