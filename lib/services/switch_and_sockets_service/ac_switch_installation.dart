...
class AcSwitchAndSocketsPage extends StatefulWidget {
  const AcSwitchAndSocketsPage({super.key});

  @override
  _AcSwitchAndSocketsPageState createState() => _AcSwitchAndSocketsPageState();
}

class _AcSwitchAndSocketsPageState extends State<AcSwitchAndSocketsPage> {
