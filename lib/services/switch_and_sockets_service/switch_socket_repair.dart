...
class SwitchSocketRepair extends StatefulWidget {
  const SwitchSocketRepair({super.key});

  @override
  _SwitchSocketRepairState createState() => _SwitchSocketRepairState();
}

class _SwitchSocketRepairState extends State<SwitchSocketRepair> {
