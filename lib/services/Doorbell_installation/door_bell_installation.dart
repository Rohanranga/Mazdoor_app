...
class DoorbellInstallationPage extends StatefulWidget {
  const DoorbellInstallationPage({super.key});

  @override
  _DoorbellInstallationPageState createState() =>
      _DoorbellInstallationPageState();
}

class _DoorbellInstallationPageState extends State<DoorbellInstallationPage> {
